...
export type EgressLimits = { maxTravel: number; occLoadFactor: number; widthPerOccupantMm: number; twoExitsAbove: number; minExitWidth: number; maxCompartment: number; commonPath: number }
...
export const CODE_PRESETS: Record<CodeKey, CodePreset> = {
  IBC: {
    ...
    egress: { maxTravel: 91, occLoadFactor: 9.3, widthPerOccupantMm: 5.1, twoExitsAbove: 49, minExitWidth: 1.118, maxCompartment: 4600, commonPath: 23 },
  },
  UK: {
    ...
    egress: { maxTravel: 45, occLoadFactor: 6, widthPerOccupantMm: 5.0, twoExitsAbove: 60, minExitWidth: 1.05, maxCompartment: 2000, commonPath: 18 },
  },
  EU: {
    ...
    egress: { maxTravel: 40, occLoadFactor: 7, widthPerOccupantMm: 5.0, twoExitsAbove: 50, minExitWidth: 1.2, maxCompartment: 1600, commonPath: 15 },
  },
}
